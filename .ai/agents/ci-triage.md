...
| `Failed to apply plugin 'org.jetbrains.kotlin.android'` | AGP 9 has built-in Kotlin support and rejects the separate plugin | Remove the plugin from the module. Do not downgrade AGP. See the comment in `libs.versions.toml` |
