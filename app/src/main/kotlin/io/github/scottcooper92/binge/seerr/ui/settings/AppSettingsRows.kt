...
/**
 * This app's own group: report a bug in it on GitHub, and whether a shake offers to. Unlike every
 * other group it is about the app, not the server, so it shows for every user.
 */
@Composable
