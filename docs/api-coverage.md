...
| `DELETE /issue/{issueId}` | Delete issue | v1.28.0 | v1.1.0 | yes | The issue page's actions sheet, behind a confirm; the cached row goes with it. |
...
| `POST /issue/{issueId}/{status}` | Update an issue's status | v1.28.0 | v1.1.0 | yes | Resolve and Reopen on the issue page; the cached row moves with it. |
